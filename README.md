...
mean±std (10 seed). 미실행 조건((f))은 `–`. per-seed 원본·accuracy 보조표는 [`results/SUMMARY.md`](results/SUMMARY.md).

| 데이터셋 | (a) HAN | (b1) +noise | (b2) +mix | (c) +위상 | (d) RGCN | (e1) +noise | (e2) +mix | (f) +위상 |
|---|---|---|---|---|---|---|---|---|
| acm | 0.895±0.006 | 0.887±0.008 | 0.899±0.006 | 0.894±0.008 | **0.925±0.006** | 0.919±0.013 | 0.923±0.012 | – |
| dblp | 0.786±0.013 | 0.776±0.010 | 0.878±0.018 | 0.862±0.013 | 0.934±0.004 | 0.930±0.008 | **0.939±0.005** | – |
| imdb | 0.438±0.009 | 0.441±0.004 | 0.447±0.021 | 0.450±0.019 | **0.636±0.004** | 0.579±0.008 | 0.634±0.004 | – |
| freebase | 0.146±0.055 | 0.160±0.059 | 0.162±0.027 | 0.144±0.051 | **0.209±0.108** | 0.158±0.061 | 0.207±0.056 | – |
